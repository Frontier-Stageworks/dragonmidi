...
- [ ] **MAP-AXIS-003**: The system shall restrict OSC axis (direct) target selection to axis names present in the OSC Listener's currently discovered list (`OSC-DISCOVER-005`, `docs/specs/osc-io.md`); it shall not accept an arbitrary or free-text axis name.
